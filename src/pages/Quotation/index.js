    ...
    <>
      ...
      <div className="w-full bg-pink8 overflow-remove">
        ...
        <div className="w-full relative bg-mainpink">
          ...
          <div className="w-full max-w-1296 mx-auto px-8 sm:px-12 xl:px-24 1xl:px-32 pb-6 bg-mainpink rounded-2xl">
        ...
        <div className="w-full bg-maingray px-0 py-4 block md:hidden">
          <div className="bg-mainpink w-full flex justify-between items-center rounded-bl-2xl rounded-br-2xl px-8 py-6">
            <p className="text-gray text-lg font-SpartanBold">¿Empezamos?</p>
            <a
              href="/auto#auto"
              className="px-3 sm:px-10 py-3 bg-purple rounded-md text-white font-RobotoMedium text-base shadow-lg"
            >
              Cotizar ahora
            </a>
          </div>
