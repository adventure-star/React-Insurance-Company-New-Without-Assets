                ...
                <div className="w-full max-w-778 mr-auto">
                    <div className="w-full pl-8 pt-15">
                        ...
                        <div className="pt-4 pl-2 sm:pl-8 lg:pl-16 pb-8 sm:pb-40">
                            {step === 1 &&
                                <>
                                    <p className="text-black font-SpartanBold text-xl md:text-2xl pb-4 pr-3 pt-6">Contanos sobre tu hogar</p>
                                    <form className="pr-8 sm:pr-16 lg:pr-24 1xl:pr-40" onSubmit={sendData}>
                                        ...
                                        <p className="text-2xl font-SpartanBold text-black py-6">¿Qué relación tenés con tu hogar?</p>
                            ...
                            {step === 2 &&
                                <>
                                    ...
                                    <div className="pr-8 sm:pr-16 lg:pr-24 1xl:pr-40">
                                        ...
                                        <div className="w-full text-right">
                                            <button type="submit" className={`${step2Valid ? `bg-purple` : `bg-pink2`} text-white rounded-lg font-RobotoMedium text-base px-16 py-3 mt-8 sm:mt-10 shadow-lg`}>Cotizar</button>
                                        </div>
                                    </div>
                                </>
                            }
