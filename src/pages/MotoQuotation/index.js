      ...
      <div className="w-full bg-pink8 overflow-remove">
                ...
                <div className="w-full pl-0 lg:pl-8">
                  <div className="md:flex items-center justify-between mb-4">
                    ...
                    <div className="hidden md:block">
                      <div className="flex items-center cursor-pointer" onClick={() => setDesc(!desc)}>
                        <img src={updown} alt="updown" />
        ...
        <div className="w-full bg-maingray px-0 py-4 block md:hidden">
          <div className="bg-mainpink w-full flex justify-between items-center rounded-bl-2xl rounded-br-2xl px-8 py-6">
            ...
            <a href="/moto#moto" className="px-3 sm:px-10 py-3 bg-purple rounded-md text-white font-RobotoMedium text-base shadow-lg">
              Cotizar ahora
            </a>
          </div>
        </div>
