...
import QuotationDetailsVerticalCasa from '../QuotationDetailsVerticalCasa';


const QuotationVerticalSelectCasa = (props) => {
    ...
    return (
        <div className={`w-full ${props.item === props.selected ? `bg-pink9` : ` bg-white`} relative mt-6 pt-10 pb-0 px-10 rounded-2xl`}>
            ...
            <div className="w-full flex justify-between">
                ...
                <QuotationDetailsVerticalCasa item={props.item} selected={props.selected} coverageid={props.data.coverage.id} />
            </div>
...
export default QuotationVerticalSelectCasa;
