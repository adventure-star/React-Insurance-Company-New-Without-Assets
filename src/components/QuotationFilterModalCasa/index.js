...
import QuotationCheckBox from "../QuotationCheckBox"
import RangeSlider from "../RangeSlider"
import { formatNumber } from '../../services/utils'


const QuotationFilterModalCasa = (props) => {
    ...
    const filterRemove = () => {
        setSelectedInsurers([])
        setSelectedMonths([])
        setPrice(props.priceMax)
        setInsuranceSum(props.insuranceSumMax)
        setInsurersLength(3)
        setFix(false);
        setVariable(false);
    }
    ...
    const applyChanges = () => {
        props.receiveData(price, insuranceSum, selectedInsurers, selectedMonths, fix, variable);
...
export default QuotationFilterModalCasa;
