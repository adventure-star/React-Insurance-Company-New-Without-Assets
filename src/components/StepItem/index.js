...
const StepItem = (props) => {
    ...
    return (
        <>
            {!!props.image ?
                <div className={`${props.item === props.state ? `bg-pink5 border border-purple shadow-md` : `bg-pink4`} w-full rounded-2xl relative cursor-pointer`} onClick={props.onClick}>
